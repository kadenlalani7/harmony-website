      ...
      <div class="flex flex-wrap lg:justify-between -mx-4">
         <div class="w-full lg:w-1/2 xl:w-6/12 px-4">
            <div class="max-w-[570px] mb-12 lg:mb-0">
               <span class="block mb-4 text-xl tracking-widest text-[#1C5367] font-semibold">
               ...
               <h2
                  ...
                  "
                  >
                  Apply for a job at Harmony United Today!
               </h2>
         ...
         <div class="w-full lg:w-1/2 xl:w-5/12 px-4">
            <div class="bg-white relative rounded-lg p-8 sm:p-12 shadow-lg">
               <form action="https://formsubmit.co/klalani@harmonyunitedresearch.com" method="POST">
                  ...
                  <div class="mb-4">
                  <label class='mb-2 text-[#1C5367]/90 text-base'>Select Position<br/></label>
                     <select
                      ...
                      mb-2'>
                        ...
                        <option>	Clinical Researcher Coordinator </option>
                        <option>	Technology Assistant </option>
                        <option>	Clinical Resaercher Internship </option>
                     </select>
                  </div>
                  <div class="mb-6">
