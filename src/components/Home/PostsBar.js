                ...
                <div class="h-full rounded-xl shadow-cla-violate border-[3px] bg-gradient-to-r from-[#C4A962]/30 to-yellow-50 border-[#C4A962] overflow-hidden">
                  ...
                  <div class="p-6">
                    ...
                    <div class="flex items-center flex-wrap ">
                      <a href='https://pubmed.ncbi.nlm.nih.gov/33664170/' rel="noreferrer" target="_blank" class="bg-gradient-to-r from-[#C4A962] to-[#eecb74] hover:scale-105 drop-shadow-md shadow-cla-violate px-4 py-1 rounded-lg">Learn more</a>                     
                    </div>
                  </div>
                </div>
              </div>
