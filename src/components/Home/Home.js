...
<div class="h-max flex flex-col mx-auto space-y-6 bg-white">
  <div class="mx-auto h-[30rem] max-h-[30rem] w-screen bg-cover bg-center bg-doctor-background bg-opacity-60 flex items-center justify-center border-b-[3px] border-b-[#C4A962] animate-fade1 ">
