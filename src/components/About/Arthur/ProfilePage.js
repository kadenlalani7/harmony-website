            ...
            <div class="md:flex no-wrap md:-mx-2 ">
                ...
                <div class="w-full md:border-[3px] p-2 rounded-lg border-[#C4A962] md:w-3/12 md:mx-2">
                    ...
                    <div class="bg-white border-[#1C5367]">
                        ...
                        <p class="text-sm text-[#1C5367] hover:text-[#1C5367]/80 leading-6">Arthur Imai is currently
                        the president of Harmony United Research, helping ot conduct clinical trials and patients.</p>
                    </div>
                    {/* <!-- End of profile card --> */}
                    <div class="my-4"></div>
                    {/* <!-- Friends card --> */}
                        ...
                        <div class="text-gray-700">
                            <div class="grid md:grid-cols-2 text-sm">
                                <div class="grid grid-cols-2">
                                    ...
                                    <div class="px-4 py-2">Arthur</div>
                                </div>
                                <div class="grid grid-cols-2">
                                    <div class="px-4 py-2 font-semibold">Last Name</div>
                                    <div class="px-4 py-2">Imai</div>
                                </div>
                                <div class="grid grid-cols-2">
                                ...
                                <div class="grid grid-cols-2">
                                    ...
                                    <div class="px-4 py-2">
                                        <a class="text-blue-800" href="mailto:aimai@harmonyunitedresearch.com">aimai@harmonyunitedresearch.com</a>
                                    </div>
                                </div>
                            </div>
                        </div>
