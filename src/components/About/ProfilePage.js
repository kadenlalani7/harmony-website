  ...
  return (
        <div class="container mx-auto my-5 p-5 pt-14">
            <div class="md:flex no-wrap md:-mx-2 ">
                {/* <!-- Left Side --> */}
                <div class="w-full md:border-[3px] rounded-lg border-[#C4A962] md:w-3/12 md:mx-2">
                    {/* <!-- Profile Card --> */}
                    <div class="bg-white p-3 border-t-4 border-[#1C5367]">
                        ...
                        <ul
                            class="bg-gray-100 text-[#1C5367] hover:shadow py-2 px-3 mt-3 divide-y rounded shadow-sm">
                            <li class="flex items-center py-3">
                                <span>Status</span>
                                <span class="ml-auto"><span
                                        class="bg-[#1C5367] py-1 px-2 rounded text-white text-sm">Active</span></span>
                            </li>
                            <li class="flex items-center py-3">
                    ...
                    <div class="bg-white p-3 hover:shadow">
                        <div class="flex items-center space-x-3 font-semibold text-[#1C5367] text-xl leading-8">
                            <span class="text-[#C4A962]">
                        ...
                        <div class="grid grid-cols-3">
                            <div class="text-center my-2">
                                <img class="h-16 w-16 rounded-full mx-auto"
                                    ...
                                    alt=""/>
                                <a href="#" class="text-[#1C5367]">Kojstantin</a>
                            </div>
                            <div class="text-center my-2">
                                <img class="h-16 w-16 rounded-full mx-auto"
                                    src="https://widgetwhats.com/app/uploads/2019/11/free-profile-photo-whatsapp-4.png"
                                    alt=""/>
                                <a href="#" class="text-[#1C5367]">James</a>
                            </div>
                            <div class="text-center my-2">
                                <img class="h-16 w-16 rounded-full mx-auto"
                                    src="https://lavinephotography.com.au/wp-content/uploads/2017/01/PROFILE-Photography-112.jpg"
                                    alt=""/>
                                <a href="#" class="text-[#1C5367]">Natie</a>
                            </div>
                            <div class="text-center my-2">
                                <img class="h-16 w-16 rounded-full mx-auto"
                                    src="https://bucketeer-e05bbc84-baa3-437e-9518-adb32be77984.s3.amazonaws.com/public/images/f04b52da-12f2-449f-b90c-5e4d5e2b1469_361x361.png"
                                    alt=""/>
                                <a href="#" class="text-[#1C5367]">Casey</a>
                            </div>
                        </div>
                    </div>
                    {/* <!-- End of friends card --> */}
                    ...
                    <div class="bg-white p-3 shadow-sm rounded-sm md:border-[3px] rounded-lg border-[#C4A962]">
                        ...
                        <div class="grid grid-cols-2">
                            ...
                            <div>
                                ...
                                <ul class="list-inside space-y-2">
                                    <li>
                                        <div class="text-[#1C5367]">Masters Degree in Oxford</div>
                                        <div class="text-[#1C5367] text-xs">March 2020 - Now</div>
                                    </li>
                                    <li>
                                        <div class="text-[#1C5367]">Bachelors Degreen in LPU</div>
                                        <div class="text-[#1C5367] text-xs">March 2020 - Now</div>
                                    </li>
                                </ul>
                            </div>
